...
export default function useWebRTCAudioSession(
    ...
    const languageMessage = {
      ...
      item: {
        ...
        content: [
          {
            type: "input_text",
            text: "Speak and respond only in English. It is crucial that you maintain your responses in English. If the user speaks in other languages, you should still respond in English",
          },
        ],
      },
    };
   ...
   */
  /**
   * Start a new session, with support for passing a system prompt to OpenAI Realtime API.
   * @param {string} [systemPrompt] - Optional system prompt to set context for the assistant.
   */
  ...
  async function startSession() {
    try {
      ...
      dataChannel.onopen = () => {
        ...
        // Send initial brief request once channel is open
        const initialMessage = {
          ...
          item: {
            ...
            content: [
              {
                type: "input_text",
                text: `Brief me on Media Coverage Report on Ed Sheeran answer any questions using this report ${systemPrompt}`,
              },
            ],
          },
        };
      ...
      // There is currently no documented way to pass a system prompt in the initial SDP offer or as a query param.
      // The recommended way is to send a system message as the first message over the data channel (see above).
